"""
Django settings for frosty_snow_42844 project.
...
ROOT_URLCONF = 'frosty_snow_42844.urls'
...
WSGI_APPLICATION = 'frosty_snow_42844.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_snow_42844 API",
    "DESCRIPTION": "API documentation for frosty_snow_42844 App",
    "VERSION": "v1",
}
